...
function openScanFile(title,token,bizNo,archivesNo){
 	 //var pdfUrl ="http://127.0.0.1:8848/jeecg-boot/generic/web/viewer.html?file="+encodeURIComponent("http://127.0.0.1:8848/jeecg-boot/test/jeecgDemo/getPdfUrl?title="+encodeURI(title));
